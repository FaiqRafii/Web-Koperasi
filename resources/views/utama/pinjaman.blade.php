                        ...
                        <div class="card mb-4">
                          <div class="card-body">
                            <form action="" method="">
                              ...
                              <div class="row mb-3 ">
                                <label for="html5-date-input" class="col-md-2 col-form-label">Tanggal Peminjaman</label>
                                <div class="col-md-10">
                                  <input class="form-control" type="date" value="2021-06-18" id="html5-date-input" />
                                </div>
                              </div>
                              <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-name">Jumlah Pinjaman</label>
                                <div class="col-sm-10">
