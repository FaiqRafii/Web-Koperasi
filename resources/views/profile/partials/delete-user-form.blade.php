<section class="space-y-6">
    ...
    <form method="post" action="{{ route('profile.destroy') }}" class="p-6" onsubmit="return confirm('Apakah Anda yakin ingin menghapus akun Anda? Tindakan ini tidak bisa dibatalkan.');">
        @csrf
        @method('delete')
